...
const styles = StyleSheet.create({
  ...
  search: { flexDirection: 'row', alignItems: 'center', gap: 8, marginTop: 16, padding: 12, borderRadius: 16, backgroundColor: '#ffffff', borderWidth: 1, borderColor: '#dde3eb' },
  input: { flex: 1 },
  list: { gap: 10, paddingTop: 14 },
  card: { flexDirection: 'row', alignItems: 'center', gap: 12, padding: 14, backgroundColor: '#ffffff', borderRadius: 18, borderWidth: 1, borderColor: '#dde3eb' },
